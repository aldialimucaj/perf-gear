...
${OBJECTDIR}/js-tests/js-runner.o: js-tests/js-runner.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -Isrc -std=c99 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/js-tests/js-runner.o js-tests/js-runner.c

${OBJECTDIR}/lib/duktape.o: lib/duktape.c 
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/duktape.o lib/duktape.c

${OBJECTDIR}/lib/duktape.h.gch: lib/duktape.h 
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -fPIC  -MMD -MP -MF "$@.d" -o "$@" lib/duktape.h

${OBJECTDIR}/src/collector.o: src/collector.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/collector.o src/collector.c

${OBJECTDIR}/src/db-measurement.o: src/db-measurement.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/db-measurement.o src/db-measurement.c

${OBJECTDIR}/src/dispatcher.o: src/dispatcher.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dispatcher.o src/dispatcher.c

${OBJECTDIR}/src/dukbridge.o: src/dukbridge.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dukbridge.o src/dukbridge.c

${OBJECTDIR}/src/linked-list.o: src/linked-list.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/linked-list.o src/linked-list.c

${OBJECTDIR}/src/measurement2json.o: src/measurement2json.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/measurement2json.o src/measurement2json.c

${OBJECTDIR}/src/perf-gear.o: src/perf-gear.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/perf-gear.o src/perf-gear.c

${OBJECTDIR}/src/pg-utils.o: src/pg-utils.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pg-utils.o src/pg-utils.c

${OBJECTDIR}/src/queue.o: src/queue.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/queue.o src/queue.c
...
${TESTDIR}/api-tests/api-general.o: api-tests/api-general.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/api-tests/api-general.o api-tests/api-general.c


${TESTDIR}/tests/collector-test.o: tests/collector-test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/collector-test.o tests/collector-test.c


${TESTDIR}/tests/dispatcher-test.o: tests/dispatcher-test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/dispatcher-test.o tests/dispatcher-test.c


${TESTDIR}/tests/db-measurement-test.o: tests/db-measurement-test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/db-measurement-test.o tests/db-measurement-test.c


${TESTDIR}/tests/dukbridge-test.o: tests/dukbridge-test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/dukbridge-test.o tests/dukbridge-test.c


${TESTDIR}/tests/linked-list-test.o: tests/linked-list-test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/linked-list-test.o tests/linked-list-test.c


${TESTDIR}/tests/measurement2json-test.o: tests/measurement2json-test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/measurement2json-test.o tests/measurement2json-test.c


${TESTDIR}/tests/perf-gear-test.o: tests/perf-gear-test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/perf-gear-test.o tests/perf-gear-test.c


${TESTDIR}/tests/pg-utils-test.o: tests/pg-utils-test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/pg-utils-test.o tests/pg-utils-test.c


${TESTDIR}/tests/queue-test.o: tests/queue-test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/queue-test.o tests/queue-test.c
...
${OBJECTDIR}/js-tests/js-runner_nomain.o: ${OBJECTDIR}/js-tests/js-runner.o js-tests/js-runner.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror -Isrc -Ilib -Isrc -std=c99 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/js-tests/js-runner_nomain.o js-tests/js-runner.c;\
	else  \
...
${OBJECTDIR}/lib/duktape_nomain.o: ${OBJECTDIR}/lib/duktape.o lib/duktape.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/duktape_nomain.o lib/duktape.c;\
	else  \
...
${OBJECTDIR}/lib/duktape_nomain.h.gch: ${OBJECTDIR}/lib/duktape.h.gch lib/duktape.h 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o "$@" lib/duktape.h;\
	else  \
...
${OBJECTDIR}/src/collector_nomain.o: ${OBJECTDIR}/src/collector.o src/collector.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror -Isrc -Ilib -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/collector_nomain.o src/collector.c;\
	else  \
...
${OBJECTDIR}/src/db-measurement_nomain.o: ${OBJECTDIR}/src/db-measurement.o src/db-measurement.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/db-measurement_nomain.o src/db-measurement.c;\
	else  \
...
${OBJECTDIR}/src/dispatcher_nomain.o: ${OBJECTDIR}/src/dispatcher.o src/dispatcher.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dispatcher_nomain.o src/dispatcher.c;\
	else  \
...
${OBJECTDIR}/src/dukbridge_nomain.o: ${OBJECTDIR}/src/dukbridge.o src/dukbridge.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dukbridge_nomain.o src/dukbridge.c;\
	else  \
...
${OBJECTDIR}/src/linked-list_nomain.o: ${OBJECTDIR}/src/linked-list.o src/linked-list.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/linked-list_nomain.o src/linked-list.c;\
	else  \
...
${OBJECTDIR}/src/measurement2json_nomain.o: ${OBJECTDIR}/src/measurement2json.o src/measurement2json.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/measurement2json_nomain.o src/measurement2json.c;\
	else  \
...
${OBJECTDIR}/src/perf-gear_nomain.o: ${OBJECTDIR}/src/perf-gear.o src/perf-gear.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/perf-gear_nomain.o src/perf-gear.c;\
	else  \
...
${OBJECTDIR}/src/pg-utils_nomain.o: ${OBJECTDIR}/src/pg-utils.o src/pg-utils.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror -Isrc -Ilib -std=c99 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pg-utils_nomain.o src/pg-utils.c;\
	else  \
...
${OBJECTDIR}/src/queue_nomain.o: ${OBJECTDIR}/src/queue.o src/queue.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror -Isrc -Ilib -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/queue_nomain.o src/queue.c;\
	else  \
