...
${OBJECTDIR}/src/db-measurement.o: src/db-measurement.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -std=c99 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/db-measurement.o src/db-measurement.c
...
${TESTDIR}/tests/db-measurement-test.o: tests/db-measurement-test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/db-measurement-test.o tests/db-measurement-test.c
...
${OBJECTDIR}/src/db-measurement_nomain.o: ${OBJECTDIR}/src/db-measurement.o src/db-measurement.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Werror -std=c99 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/db-measurement_nomain.o src/db-measurement.c;\
	else  \
