...
${OBJECTDIR}/lib/duktape.o: lib/duktape.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/duktape.o lib/duktape.c

${OBJECTDIR}/lib/duktape.h.gch: lib/duktape.h 
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -fPIC  -MMD -MP -MF "$@.d" -o "$@" lib/duktape.h
...
${OBJECTDIR}/src/dukbridge.o: src/dukbridge.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dukbridge.o src/dukbridge.c
...
${TESTDIR}/tests/dukbridge-test.o: tests/dukbridge-test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/dukbridge-test.o tests/dukbridge-test.c
...
${OBJECTDIR}/lib/duktape_nomain.o: ${OBJECTDIR}/lib/duktape.o lib/duktape.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Werror -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/duktape_nomain.o lib/duktape.c;\
	else  \
...
${OBJECTDIR}/lib/duktape_nomain.h.gch: ${OBJECTDIR}/lib/duktape.h.gch lib/duktape.h 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Werror -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o "$@" lib/duktape.h;\
	else  \
...
${OBJECTDIR}/src/dukbridge_nomain.o: ${OBJECTDIR}/src/dukbridge.o src/dukbridge.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Werror -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dukbridge_nomain.o src/dukbridge.c;\
	else  \
